...
export function ShareModal({ isOpen, onClose, type, data }: ShareModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div className="relative bg-card border border-white/10 rounded-3xl sm:rounded-3xl w-full max-w-md max-h-[calc(100dvh-32px)] overflow-y-auto scrollbar-hide shadow-[0_0_50px_rgba(0,0,0,0.5)] animate-in zoom-in-95 duration-300">
        <div className="p-8">
